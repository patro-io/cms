...
export function renderProfilePage(data: ProfilePageData): string {
  ...
  const pageContent = `
    <div class="space-y-8">
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
        <div>
          <h1 class="text-2xl/8 font-semibold text-zinc-950 dark:text-white sm:text-xl/8">${t('profile.title')}</h1>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div class="rounded-xl bg-white dark:bg-zinc-900 shadow-sm ring-1 ring-zinc-950/5 dark:ring-white/10">
            ...
            <div class="px-6 py-5 border-b border-zinc-950/5 dark:border-white/5">
              <div class="flex items-center gap-x-3">
                ...
                <div>
                  <h2 class="text-base font-semibold text-zinc-950 dark:text-white">${t('profile.profileInformation')}</h2>
                  <p class="text-sm text-zinc-500 dark:text-zinc-400">${t('profile.updateAccountDetails')}</p>
                </div>
              </div>
            </div>
            ...
            <form id="profile-form" hx-put="/admin/profile" hx-target="#form-messages" class="p-6 space-y-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label class="block text-sm font-medium text-zinc-950 dark:text-white mb-2">${t('users.firstName')}</label>
                  <input
                    type="text"
                    name="first_name"
                ...
                <div>
                  <label class="block text-sm font-medium text-zinc-950 dark:text-white mb-2">${t('users.lastName')}</label>
                  <input
                    type="text"
                    name="last_name"
              ...
              <div>
                <label class="block text-sm font-medium text-zinc-950 dark:text-white mb-2">${t('users.username')}</label>
                <input
                  type="text"
                  name="username"
              ...
              <div>
                <label class="block text-sm font-medium text-zinc-950 dark:text-white mb-2">${t('profile.emailAddress')}</label>
                <input
                  type="email"
                  name="email"
              ...
              <div>
                <label class="block text-sm font-medium text-zinc-950 dark:text-white mb-2">${t('profile.phoneNumber')}</label>
                <input
                  type="tel"
                  name="phone"
              ...
              <div>
                <label class="block text-sm font-medium text-zinc-950 dark:text-white mb-2">${t('users.bio')}</label>
                <textarea
                  name="bio"
                  rows="3"
              ...
              <div class="pt-6 border-t border-zinc-950/5 dark:border-white/5">
                <h3 class="text-base font-semibold text-zinc-950 dark:text-white mb-4">${t('profile.preferences')}</h3>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label for="timezone" class="block text-sm/6 font-medium text-zinc-950 dark:text-white mb-2">${t('profile.timezone')}</label>
                    <div class="grid grid-cols-1">
                      <select id="timezone" name="timezone" class="col-start-1 row-start-1 w-full appearance-none rounded-md bg-white dark:bg-zinc-800 py-1.5 pl-3 pr-8 text-base text-zinc-950 dark:text-white outline outline-1 -outline-offset-1 outline-zinc-500/30 dark:outline-zinc-400/30 *:bg-white dark:*:bg-zinc-800 focus-visible:outline focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-zinc-500 dark:focus-visible:outline-zinc-400 sm:text-sm/6">
                  ...
                  <div>
                    <label for="language" class="block text-sm/6 font-medium text-zinc-950 dark:text-white mb-2">${t('profile.language')}</label>
                    <div class="grid grid-cols-1">
                      <select id="language" name="language" onchange="changeUserLanguage(this.value)" class="col-start-1 row-start-1 w-full appearance-none rounded-md bg-white dark:bg-zinc-800 py-1.5 pl-3 pr-8 text-base text-zinc-950 dark:text-white outline outline-1 -outline-offset-1 outline-zinc-500/30 dark:outline-zinc-400/30 *:bg-white dark:*:bg-zinc-800 focus-visible:outline focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-zinc-500 dark:focus-visible:outline-zinc-400 sm:text-sm/6">
              ...
              <!-- Notifications -->
              <div class="pt-6 border-t border-zinc-950/5 dark:border-white/5">
                <h3 class="text-base font-semibold text-zinc-950 dark:text-white mb-4">${t('profile.notifications')}</h3>
                ...
                <div class="space-y-5">
                  <div class="flex gap-3">
                    ...
                    <div class="text-sm/6">
                      <label for="email_notifications" class="font-medium text-zinc-950 dark:text-white">${t('profile.emailNotifications')}</label>
                      <p class="text-zinc-500 dark:text-zinc-400">${t('profile.emailNotificationsDesc')}</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="lg:col-span-1 space-y-6">
          ...
          <div class="rounded-xl bg-white dark:bg-zinc-900 shadow-sm ring-1 ring-zinc-950/5 dark:ring-white/10 p-6">
            <h3 class="text-base font-semibold text-zinc-950 dark:text-white mb-4">${t('profile.profilePicture')}</h3>
          ...
          <!-- Account Info -->
          <div class="rounded-xl bg-white dark:bg-zinc-900 shadow-sm ring-1 ring-zinc-950/5 dark:ring-white/10 p-6">
            <h3 class="text-base font-semibold text-zinc-950 dark:text-white mb-4">${t('profile.accountInformation')}</h3>

            <dl class="space-y-3 text-sm">
              <div>
                <dt class="text-zinc-500 dark:text-zinc-400">${t('users.role')}</dt>
                <dd class="mt-1">
              ...
              <div>
                <dt class="text-zinc-500 dark:text-zinc-400">${t('profile.memberSince')}</dt>
              ...
              ${data.profile.last_login_at ? `
                <div>
                  <dt class="text-zinc-500 dark:text-zinc-400">${t('profile.lastLogin')}</dt>
                  <dd class="mt-1 text-zinc-950 dark:text-white">${new Date(data.profile.last_login_at).toLocaleDateString()}</dd>
                </div>
              ` : ''}
              <div>
                <dt class="text-zinc-500 dark:text-zinc-400">${t('profile.twoFactorAuth')}</dt>
                <dd class="mt-1">
                  ${data.profile.two_factor_enabled
                    ? `<span class="inline-flex items-center rounded-md bg-green-50 dark:bg-green-500/10 px-2 py-1 text-xs font-medium text-green-700 dark:text-green-400 ring-1 ring-inset ring-green-600/20 dark:ring-green-500/20">${t('profile.enabled')}</span>`
                    : `<span class="inline-flex items-center rounded-md bg-zinc-50 dark:bg-zinc-800 px-2 py-1 text-xs font-medium text-zinc-600 dark:text-zinc-400 ring-1 ring-inset ring-zinc-500/10 dark:ring-zinc-400/20">${t('profile.disabled')}</span>`
                  }
                </dd>
              </div>
            </dl>
          ...
          <!-- Security Actions -->
          <div class="rounded-xl bg-white dark:bg-zinc-900 shadow-sm ring-1 ring-zinc-950/5 dark:ring-white/10 p-6">
            <h3 class="text-base font-semibold text-zinc-950 dark:text-white mb-4">${t('profile.security')}</h3>
            ...
            <div class="space-y-2">
              ...
              >
                ...
                <span class="font-medium">${t('profile.changePassword')}</span>
              </button>
              ...
              >
                ...
                <span class="font-medium">${data.profile.two_factor_enabled ? t('profile.disable2FA') : t('profile.enable2FA')}</span>
              </button>
            </div>
          </div>
        </div>
      ...
      <div class="rounded-xl bg-white dark:bg-zinc-900 shadow-2xl ring-1 ring-zinc-950/5 dark:ring-white/10 w-full max-w-md mx-4">
        <div class="px-6 py-5 border-b border-zinc-950/5 dark:border-white/5">
          <div class="flex items-center justify-between">
            <h3 class="text-base font-semibold text-zinc-950 dark:text-white">${t('profile.changePassword')}</h3>
        ...
        <form id="password-form" hx-post="/admin/profile/password" hx-target="#password-messages" class="p-6 space-y-4">
          ...
          <div>
            <label class="block text-sm font-medium text-zinc-950 dark:text-white mb-2">${t('profile.currentPassword')}</label>
            <input
              type="password"
          ...
          <div>
            <label class="block text-sm font-medium text-zinc-950 dark:text-white mb-2">${t('profile.newPassword')}</label>
            <input
              type="password"
              name="new_password"
              required
            ...
            >
            <p class="mt-1 text-xs text-zinc-500 dark:text-zinc-400">${t('profile.passwordMinLength')}</p>
          </div>

          <div>
            <label class="block text-sm font-medium text-zinc-950 dark:text-white mb-2">${t('profile.confirmPassword')}</label>
            <input
              type="password"
    ...
    <script>
      ...
      // Localized messages for language change - safely embedded for all locales
      const PROFILE_LANGUAGE_SAVE_SUCCESS_MESSAGE = ${JSON.stringify(t('settings.saveSuccess'))};
      const PROFILE_LANGUAGE_SAVE_ERROR_MESSAGE = ${JSON.stringify(t('settings.saveError'))};
      ...
      window.changeUserLanguage = async function(language) {
        try {
          ...
          if (result.success) {
            showNotification(PROFILE_LANGUAGE_SAVE_SUCCESS_MESSAGE, 'success');
            setTimeout(() => window.location.reload(), 1000);
          } else {
            showNotification(result.error || PROFILE_LANGUAGE_SAVE_ERROR_MESSAGE, 'error');
          }
        } catch (error) {
          console.error('Error changing language:', error);
          showNotification(PROFILE_LANGUAGE_SAVE_ERROR_MESSAGE, 'error');
        }
      };
  ...
  const layoutData: AdminLayoutCatalystData = {
    ...
    pageTitle: t('navigation.profile'),
